...
# Use ada_slope.io.sample_elevation_at_points instead of local implementation
    ...
    for group_id, group in grouped:
        ...
        for i in range(half_window, len(group) - half_window):
            ...
            if slope_threshold is None:
                st_threshold = core.ADA_RUNNING_SLOPE_THRESHOLD
            else:
...
def main():
    ...
    if compute and raster_file and points_file:
        ...
        gdf_sampled = aio.sample_elevation_at_points(gdf_points, dem_path)
